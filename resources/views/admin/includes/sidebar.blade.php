<div class="sidebar-nav scrollbar scroll_light">
    <ul class="metismenu " id="sidebarNav">
        ...
        <li class="{{ Request::is('login') ? 'active' : '' }}">
            <a href="/login" aria-expanded="false">
        ...
        <li class="{{ Request::is('slideshow') ? 'active' : '' }}"><a href="/slideshow" aria-expanded="false"><i class="nav-icon ti ti-comment ti-layout-slider-alt"></i><span class="nav-title">Slideshow</span></a> </li>
        <li class="{{ Request::is('product') ? 'active' : '' }}"><a  href="/product" aria-expanded="false"><i class="nav-icon ti ti-calendar ti-dropbox"></i><span class="nav-title">Product</a>
            <!-- <ul aria-expanded="false">
                <li> <a href='calendar-full.html'>Full Calendar</a> </li>
                <li> <a href='calendar-list.html'>Calendar List</a> </li>
            </ul> -->
        </li>
        <li class="{{ Request::is('category') ? 'active' : '' }}"><a href="/category" aria-expanded="false"><i class="nav-icon ti ti-email ti-layout-grid2"></i><span class="nav-title">Category</span></a> </li>
        <li>
            <a class="has-arrow" href="#" aria-expanded="false"><i class="nav-icon ti ti-bag"></i> <span class="nav-title">UI Kit</span></a>
            <ul aria-expanded="false">
